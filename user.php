        ...
        <p class="head" >
          <div class="content">
              ...
              if (isset($_SESSION['success'])) :?>
                ...
                <hr>
                <div class="welcome-letsconnect" >
                  <img  src="images/letsconnect.jpg" width="90%" >
                </div>
          </div>
...
<div class="search-mode" >
  ...
  <div class="search-group" >
    <a class="group-connect" href="group.php"><img src="images/group-connect.png" style="background-color: black;" ></a>
  ...
  <div class="search-individual" >
    <a class="i-connect" href="search.php"><img src="images/i-connect.png" width="490px" height="258px" ></a>
